/**
 * Training Defense - SPA
 * Treino de defesa do pet
 */

function trainingDefensePage() {
    ...
    return `
      <div class="spa-page">
        <div class="spa-page-header">
          <h1 class="spa-title">🛡️ Treino de Defesa</h1>
        </div>
  ...
  const currentDefense = currentPet.defense || 1;
  const nextLevelDefense = currentDefense + 1;
  const requiredXP = 100 * nextLevelDefense;
  ...
  return `
    <div class="spa-page">
      ...
      <div class="spa-page-content">
        <!-- Stat Progress -->
        <div class="spa-card" style="border-color: rgba(0, 255, 136, 0.3); margin-bottom: 24px;">
          <h3 class="spa-subtitle">📈 Progressão</h3>
          
          <div style="margin: 16px 0;">
            <div style="display: flex; justify-content: space-between; margin-bottom: 8px;">
              <span class="spa-stat-label">Defesa Atual</span>
              <span class="spa-stat-value">${currentDefense}</span>
            </div>
            <div class="spa-progress-bar">
              <div class="spa-progress-fill" style="width: 65%;"></div>
            </div>
          </div>
        ...
        <div style="margin: 24px 0;">
          ...
          <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(150px, 1fr)); gap: 12px; margin-top: 12px;">
            ...
            " onmouseover="this.style.background = 'rgba(0, 255, 136, 0.15)'" onmouseout="this.style.background = 'rgba(0, 255, 136, 0.05)'">
              ...
              <div style="font-weight: bold; color: var(--color-text-primary);">Básico</div>
              <div class="spa-text-muted" style="font-size: 0.85em; margin-top: 8px;">+10 DEF<br>-20 ENE</div>
            </button>

            <button class="spa-card" onclick="
              alert('Treino concluído! +15 Defesa +35 XP');
              const pet = window.gameState.get('currentPet');
              pet.defense = (pet.defense || 1) + 15;
              pet.xp = (pet.xp || 0) + 35;
            ...
            " onmouseover="this.style.background = 'rgba(241, 196, 15, 0.15)'" onmouseout="this.style.background = 'rgba(241, 196, 15, 0.05)'">
              <div style="font-size: 1.8em; margin-bottom: 8px;">⚔️</div>
              <div style="font-weight: bold; color: var(--color-text-primary);">Intermediário</div>
              <div class="spa-text-muted" style="font-size: 0.85em; margin-top: 8px;">+15 DEF<br>-35 ENE</div>
            </button>

            <button class="spa-card" onclick="
              alert('Treino concluído! +25 Defesa +60 XP');
              const pet = window.gameState.get('currentPet');
              pet.defense = (pet.defense || 1) + 25;
              pet.xp = (pet.xp || 0) + 60;
            ...
            " onmouseover="this.style.background = 'rgba(255, 68, 68, 0.15)'" onmouseout="this.style.background = 'rgba(255, 68, 68, 0.05)'">
              ...
              <div style="font-weight: bold; color: var(--color-text-primary);">Avançado</div>
              <div class="spa-text-muted" style="font-size: 0.85em; margin-top: 8px;">+25 DEF<br>-60 ENE</div>
            </button>
          </div>
        </div>
