 ...
 */
function setupOpenPenWindowHandler(windowManager, getPenInfo, getNestCount, createNestsWindow, closeNestsWindow, updateNestsPosition) {
...
function registerWindowHandlers(
    ...
    setupOpenPenWindowHandler(windowManager, getPenInfo, getNestCount, createNestsWindow, closeNestsWindow, updateNestsPosition);
